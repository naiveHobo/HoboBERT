...
class BertModel(object):
  ...
  def __init__(self,
    ...
    Args:
      ...
      embedding_table: float32 tensor of shape [vocab_size, hidden_size].
      token_type_table: float32 tensor of shape [token_type_vocab_size, hidden_size].
      full_position_embeddings: float32 tensor of shape [max_position_embeddings, hidden_size].
    ...
    # Probably don't need these since input_mask and token_type_ids will always be provided
    ...
    with tf.variable_scope(scope, default_name="bert"):
      with tf.variable_scope("embeddings"):
        ...
        self.embedding_output = embedding_postprocessor(
            ...
            token_type_table=token_type_table,
  ...
  def __init__(self,
    ...
    """Constructor for HoboBert.
      Args:
          ...
          is_training: bool. rue for training model, false for eval model. Controls
            whether dropout will be applied.
          input_ids_list: list of int32 Tensor of shape [batch_size, seq_length].
    ...
    with tf.variable_scope("HoboBERT"):
      with tf.variable_scope("embeddings"):
      ...
      for transformer_idx in range(num_transformer_models):
        self.transformer_list.append(BertModel(config=config,
...
def get_assignment_map_from_checkpoint(tvars, init_checkpoint, init_from_checkpoint=True):
...
def embedding_lookup(input_ids,
  ...
  Args:
    ...
    use_one_hot_embeddings: bool. If True, use one-hot method for word
      ...
      for TPUs.
    embedding_table: tensor. If None, new variable is created for the
      embedding table. If defined, the embedding table is used for look up.
...
def embedding_postprocessor(input_tensor,
  ...
  if use_position_embeddings:
    ...
    with tf.control_dependencies([assert_op]):
      if full_position_embeddings is None:
        full_position_embeddings = tf.get_variable(
